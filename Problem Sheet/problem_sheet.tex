...
\begin{alignat}{1}
    ...
    \sigma &= \sqrt{\left(\frac{\sum\limits_{1}^{N} x_{i}^{2}}{N}-\bar{x}^{2}\right)}
\end{alignat}
...
\section{Errors}
Look at the source file "compilation\_errors.f90". It contains many errors for a very simple program. Try to compile the code and use the errors the compiler gives you to work out what's wrong with it and fix it.
